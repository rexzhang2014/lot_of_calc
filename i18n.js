(function (global) {
  const translations = {
    en: {
      ...
      prepaymentTitle: 'Repayment actions',
      prepaymentIntro: 'Choose a repayment month and an amount to apply another one-time repayment.',
    ...
    zh: {
      ...
      balanceHeader: '余额',
      languageLabel: '语言',
      prepaymentTitle: '提前还款操作',
      prepaymentIntro: '选择还款期数并输入金额，连续多次应用提前还款。',
